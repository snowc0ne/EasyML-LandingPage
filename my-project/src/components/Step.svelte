...
<a
  href={step.href}
  target="_blank"
  class="p-4 sm:p-6 md:p-8 flex flex-col gap-4 rounded-lg border border-soild border-violet-700 text-center group cursor-pointer hover:border-violet-400 duration-200"
>
  <div
  ...
  <div class="flex-1 flex justify-between gap-4 items-center">
    ...
    >
      <p class="relative z-4">Go &rarr;</p>
    </div>
  </div>
</a>
